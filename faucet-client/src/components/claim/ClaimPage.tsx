...
import { isEmbedMode, notifyParentReturnToStart } from '../../utils/EmbedMode';
          ...
          <div className='row'>
            ...
            <div className='col-4'>
              <button 
                ...
                onClick={() => {
                  notifyParentReturnToStart();
                  this.props.navigateFn("/");
                }}>
                  {isEmbedMode() ? "Return to clawing" : "Return to startpage"}
                </button>
            </div>
          </div>
        : null}
    ...
    return (
      <div className='claim-status'>
        <div className='alert alert-primary spinner-alert'>
          ...
          <span className="spinner-text">The clawing service is now processing your claim...</span>
