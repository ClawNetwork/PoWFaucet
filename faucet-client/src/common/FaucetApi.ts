...
export class FaucetApi {
  ...
  public deriveSmartAccount(addr: string): Promise<{success: boolean; ownerAddress?: string; smartAccountAddress?: string; error?: string}> {
    return this.apiPost("/deriveSmartAccount", {}, { addr });
  }
